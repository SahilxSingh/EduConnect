...
import { queryAPI, userAPI, aiAPI } from "@/lib/api";
...
export default function AskDoubtPage() {
  ...
  const handleSubmitQuery = async (e) => {
    ...
    if (!selectedTeacher) {
      alert("Please select a teacher or the AI assistant");
      return;
    }

    // If student chooses AI assistant, don't create a DB query – just ask Gemini
    if (selectedTeacher === "ai") {
      try {
        setLoading(true);
        setAiError("");
        setAiAnswer("");

        const { answer } = await aiAPI.askDoubtWithGemini({
          question: queryText,
          studentId: userId,
        });
        ...
        const errorMessage = error.message || "Failed to get AI answer. Please try again.";
  ...
  const handleSuggestAnswer = async (query) => {
    ...
    try {
      ...
      const { answer } = await aiAPI.askDoubtWithGemini({
        ...
        studentId: query.student?.userId,
      });
      ...
      const errorMessage = error.message || "Failed to get AI suggestion. Please try again.";
      alert(errorMessage);
    } finally {
      setLoading(false);
    }
    ...
    return (
      <div className="container mx-auto px-4 py-8 max-w-4xl">
            ...
            <form onSubmit={handleSubmitQuery} className="space-y-4">
              <div className="space-y-2">
                ...
                >
                  ...
                  <option value="ai">Ask AI Assistant (Gemini)</option>
        ...
        {aiAnswer && (
          <Card className="mb-6">
            <CardHeader>
              <CardTitle>AI Suggested Answer</CardTitle>
              <CardDescription>
                This answer is generated by Gemini. Please double-check and, if
                needed, confirm with your teacher.
              </CardDescription>
            </CardHeader>
            <CardContent>
    ...
    return (
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <div className="flex items-center space-x-2 mb-6">
          ...
          <h1 className="text-3xl font-bold text-blue-600">Answer Student Queries</h1>
        </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex flex-wrap gap-2">
                          ...
                          <Button
                            ...
                            variant="outline"
                            disabled={loading}
                            onClick={() => handleSuggestAnswer(query)}
                          >
